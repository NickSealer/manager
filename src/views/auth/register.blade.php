...
<div class="container main">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2><i class="fas fa-user-edit"></i>  {{ __('Registrar') }}</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-ou btn-outline-primary btn-block">
                                    <i class="far fa-paper-plane"></i> {{ __('Registrar') }}
                                </button>
                            </div>
                        </div>
                    </form>
